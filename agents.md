...
- Eligible models (need native tool-calling): `Qwen3-32B`, `Llama-3.1-8B-Instruct`,
  `Llama-3.3-70B-Instruct`. Reasoning models also expose a `-thinking` variant;
  `<think>` tokens are hidden from agents on the plain name.
